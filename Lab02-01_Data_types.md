...
ตอบ ในข้อ 2.1 พบว่า ตัวแปร myInteger กำหนดให้เป็นชนิดข้อมูล int และกำหนดค่าเริ่มต้นเป็น 100 ซึ่งเมื่อนำมาแสดงผลผ่าน Serial Monitor ก็แสดงค่าออกมาตรงตามที่กำหนดไว้
ผลลัพธ์ที่ได้ ตรงตามหลักการทางคณิตศาสตร์ เพาระค่าจำนวนเต็ม 100 ถูกเก็บและแสดงผลอย่างถูกต้องตามที่ตั้งไว้ในโปรแกรม
